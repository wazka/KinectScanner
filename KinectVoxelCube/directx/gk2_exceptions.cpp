...
CustomException::CustomException(const std::wstring& message, const wchar_t* location)
	: Exception(location), m_message(message)
{
	
}

CustomException::CustomException(std::wstring&& message, const wchar_t* location)

...
KinectScanData KinectScanner::GetScanData() const
{
...
HRESULT KinectScanner::ExtractFrameData(NUI_IMAGE_FRAME &imageFrame)
{
    HRESULT hr;
...
void KinectScanner::ProcessFrame()
{
    HRESULT hr = S_OK;
...
HRESULT KinectScanner::ResetVolume()
{
    if (nullptr == voxelVolume)
        return E_FAIL;
...
void KinectScanner::SetErrorMessage(WCHAR * szMessage)
{
